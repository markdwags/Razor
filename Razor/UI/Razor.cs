...
namespace Assistant
{
    public partial class MainForm
    {
            ...
            if (e.Button == MouseButtons.Right && e.Clicks == 1)
            {
                ...
                if (a != null)
                {
                    ...
                    if (actionList.Items.Count > 1)
                    {
                        ...
                        menu.Items.Add(Language.GetString(LocString.MoveDown), null,
        ...
        private void agentSubList_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            //    ContextMenuStrip menu = new ContextMenuStrip();
            //    //menu.Items.Add(Language.GetString(LocString.Reload), null, new EventHandler(onMacroReload));
            //    menu.Items.Add("Import (Copy from clipboard)", null, new EventHandler(OnAgentImport));
            //    menu.Items.Add("-");
            //    menu.Items.Add("Export (Copy to clipboard)", null, new EventHandler(OnAgentExport));
        ...
        private void scriptList_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            /*if (e.Button == MouseButtons.Right && e.Clicks == 1)
            {
                ...
                menu.Items.Add("New", OnScriptNew);
                menu.Items.Add($"Rename '{script.Name}'", null, OnScriptRename);
                menu.Items.Add($"Delete '{script.Name}'", null, OnScriptDelete);
