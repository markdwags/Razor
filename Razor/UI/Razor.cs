...
namespace Assistant
{
    public partial class MainForm
    {
        ...
        public void InitConfig()
        {
            ...
            NextFriendHighlight.SafeAction(s => { s.Checked = Config.GetBool("NextFriendHighlight"); });
        ...
        private void NextFriendHighlight_CheckedChanged(object sender, EventArgs e)
        {
            Config.SetProperty("NextFriendHighlight", NextFriendHighlight.Checked);
        }
